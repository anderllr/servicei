...
//A partir daqui os novos
// empresa
const AsyncEmpresaComponent = Loadable({
    loader: () => import("Routes/config/empresa"),
    loading: () => <RctPageLoader />
});

const AsyncUsuarioComponent = Loadable({
    loader: () => import("Routes/config/usuario"),
    loading: () => <RctPageLoader />
});
