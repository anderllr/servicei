...
class UserBlock extends Component {
     ...
     */
    logoutUser() {
        this.props.logoutUserFromFirebase(this.props.apolloClient);
    }
...
// map state to props
const mapStateToProps = ({ settings, apolloClient }) => {
    return settings, { apolloClient };
};
